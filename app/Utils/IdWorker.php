...
class IdWorker
{
    ...
    // 静态方法
    public static function getNextId($workId=1) {
      if (empty(self::$idWorker[$workId])) {
        self::$idWorker[$workId] = new IdWorker($workId);
      }
      return self::$idWorker[$workId]->nextId();
    }
}
